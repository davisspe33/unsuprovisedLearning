...
def plotmodelLearn():
    ...
    for z in l:
        ...
        train_sizes, train_scores, test_scores, fit_times, _ = learning_curve(MLPClassifier(max_iter=400, hidden_layer_sizes=50), x_kmeans, y, train_sizes=train_sizes, return_times=True)
